describe("LinkedList", function() {
	...
	xit("checks add and push functions", function(){
		var item = "myItem", item2 = "myItem2" , item3 = "myItem3";
		var onAddSpy = jasmine.createSpy("onAdd");
		l.onAdd.add(onAddSpy);
	...
	xit("checks remove, removeByIndex and pop functions", function(){
